...
# On crée un lien : Colab croit que le dossier est local, mais il lit sur le Drive
!ln -s /content/drive/MyDrive/QuizApp_Avatar/LivePortrait /content/LivePortrait

# On installe juste les outils (obligatoire à chaque fois)
!pip install -r /content/LivePortrait/requirements.txt
!pip install fastapi uvicorn pyngrok nest_asyncio python-multipart




# Lance cette commande pour vérifier
!ls /content/LivePortrait/pretrained_weights/liveportrait/base_models/
